...
if isfile(input_file_path)
    ...
    threshold = 3; % Can be adjusted based on the dataset and desired sensitivity

    % Remove/interpolate outliers and handle NaN values for inputs
    for i = 1:num_inputs
    ...
    % Remove/interpolate outliers and handle NaN values for outputs
    for i = 1:num_outputs
    ...
    % Compute mean and variance on the whole data set and normalize
    for i = 1:num_inputs
