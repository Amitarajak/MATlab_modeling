...
New_Data5 = Data5;
New_Data5(outlier_indices) = NaN;  % Set outliers to NaN (or any other desired value)
...
ylabel('Data Values');
grid on;
% Saving the New_Data5 file
save('New_Data5.mat', 'New_Data5');
